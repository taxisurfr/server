...
@NamedQueries({
    ...
    @NamedQuery(name = "Booking.getByRoute", query = "SELECT s FROM Booking s WHERE (s.route = :route or s.route= :routeAlternative) and (s.orderType=:orderType1 OR s.orderType=:orderType2)order by date"),
